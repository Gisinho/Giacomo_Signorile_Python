"""Utilizzate la linear regression per analizzare il dataframe di esempio con Fabbisogno calorico 
giornaliero di un uomo in base alla sua età, 
...
file_path = '25 luglio/fabbisogno calorico.csv'
...
array_x = np.array(x) #converto in array numpy
array_y = np.array(y)
